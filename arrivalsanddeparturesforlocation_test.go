...
func TestArrivalsAndDeparturesForLocationListWithOptionalParams(t *testing.T) {
	...
	_, err := client.ArrivalsAndDeparturesForLocation.List(context.TODO(), onebusaway.ArrivalsAndDeparturesForLocationListParams{
		Lat:                  onebusaway.F(0.000000),
		Lon:                  onebusaway.F(0.000000),
		EmptyReturnsNotFound: onebusaway.F(true),
		LatSpan:              onebusaway.F(0.000000),
		LonSpan:              onebusaway.F(0.000000),
		MaxCount:             onebusaway.F(int64(1000)),
		MinutesAfter:         onebusaway.F(int64(0)),
		MinutesBefore:        onebusaway.F(int64(0)),
		Radius:               onebusaway.F(0.000000),
		RouteType:            onebusaway.F("routeType"),
