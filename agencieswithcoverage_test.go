...
func TestAgenciesWithCoverageListWithOptionalParams(t *testing.T) {
	...
	err := client.AgenciesWithCoverage.List(context.TODO(), tempopentransit.AgenciesWithCoverageListParams{
