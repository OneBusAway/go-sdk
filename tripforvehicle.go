...
type TripForVehicleGetResponse struct {
	Data TripForVehicleGetResponseData `json:"data" api:"required"`
...
type TripForVehicleGetResponseData struct {
	Entry      TripForVehicleGetResponseDataEntry `json:"entry" api:"required"`
...
type TripForVehicleGetResponseDataEntrySchedule struct {
	...
	StopTimes      []TripForVehicleGetResponseDataEntryScheduleStopTime `json:"stopTimes" api:"required"`
