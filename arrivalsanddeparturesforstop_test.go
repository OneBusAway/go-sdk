...
func TestArrivalsAndDeparturesForStopGetWithOptionalParams(t *testing.T) {
	...
	err := client.ArrivalsAndDeparturesForStop.Get(
		context.TODO(),
		"string",
		tempopentransit.ArrivalsAndDeparturesForStopGetParams{
